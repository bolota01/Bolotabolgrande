...
local garages = {
  {name="Garage", colour=3, id=357, x=215.124, y=-791.377, z=29.646, h=0.0},
	...
	{name="Garage", colour=3, id=357, x=1387.5604248047, y=-578.10504150391, z=74.3388671875, h=0.0},
    ...
    {name="Garage", colour=3, id=357, x=1777.0653076172, y=3335.5187988282, z=41.190231323242, h=0.0},
  ...
  {name="Garagem", colour=3, id=357, x=1346.4639892578, y=-747.49670410156, z=67.39363861084, h=0.0},
    ...
    {name="Garage", colour=3, id=357, x=-795.45538330078, y=304.45397949218, z=85.70043182373, h=0.0},
    ...
    {name="Garage", colour=3, id=357,x=-989.15130615234,y=-2705.5751953125,z=13.83068561554, h=0.0},
}
