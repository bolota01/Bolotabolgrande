...
{entering = {-42.685169219971,-1099.9609375,26.422336578369}, inside = {-49.414443969727,-1110.2772216797,26.435815811157}, outside = {-62.949256896973,-1100.1599121094,26.270923614502}},
}
			...
			while #vehshop_blips > 0 do
				...
				for i,b in ipairs(vehshop_blips) do
					if IsPlayerWantedLevelGreater(GetPlayerIndex(),0) == false and vehshop.opened == false and IsPedInAnyVehicle(vehSR_LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(vehSR_LocalPed())) < 5 then
						DrawMarker(1,b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],0,0,0,0,0,0,1.0001,1.0001,0.5001,0,155,255,200,0,0,0,0)
