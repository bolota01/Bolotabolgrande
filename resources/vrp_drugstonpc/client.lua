...
while true do
  ...
  if selling then
    local player = GetPlayerPed(-1)
    local playerloc = GetEntityCoords(player, 0)
    drawTxt(0.90, 1.40, 1.0,1.0,0.4, "Negociando: faltam ~b~" .. secondsRemaining .. "~w~ segundos.", 255, 255, 255, 255)
    ...
    if rejected then
      drawTxt(0.90, 1.40, 1.0,1.0,0.4, "Essa pessoa ~r~rejeitou ~w~sua oferta ~r~", 255, 255, 255, 255)
    end
  end
  end)
