...
cfg.emotes = {
  ...
  ["Fazer Churrasco"] = {false, {task="PROP_HUMAN_BBQ"}, false},
  ["Mendigo"] = {false, {task="WORLD_HUMAN_BUM_FREEWAY"}, false},
  ["Deitar3"] = {false, {task="WORLD_HUMAN_BUM_SLUMPED"}, false},
  ["Paparazi"] = {false, {task="WORLD_HUMAN_MOBILE_FILM_SHOCKING"}, false},
  ["Soprador de folhas"] = {false, {task="WORLD_HUMAN_GARDENER_LEAF_BLOWER"}, false},
  ["Jardineiro"] = {false, {task="WORLD_HUMAN_GARDENER_PLANT"}, false},
  ["Tocar Instrumento"] = {false, {task="WORLD_HUMAN_MUSICIAN"}, false},
